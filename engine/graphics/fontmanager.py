...
class FontManager:
    ...
    # font style is dynamically applied by the dialog renderer for dialog fonts
    FONT_FACES = {
        "DialogSmall": ("Emerald", 20, FontStyle.REGULAR),
        "DialogBig": ("Emerald", 42, FontStyle.REGULAR),
        "DialogRegular": ("Emerald", 32, FontStyle.REGULAR),
