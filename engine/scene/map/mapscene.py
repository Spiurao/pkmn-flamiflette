...
class MapScene(Scene):
    ...
    def __init__(self, engine : Engine, map : str, spawnPosition : Tuple):
        ...
        self.__dialogFrame = Frame(self.__dialogBoundaries, self.__window)

        self.__dialogRenderer = None  # the DialogRenderer for the current dialog
    ...
    def showDialog(self, text : str, cb : Callable, payload : Dict):
        ...
        self.__dialogRenderer = DialogRenderer(self.__window, self.__dialogFrame, text, self.onDialogEnd)
